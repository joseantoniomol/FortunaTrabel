...
define('FINISH_MESSAGE', 'Gracias por Suscribirte.');
...
<form class="formoid-metro-orange" style="background-color:#FFFFFF;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;max-width:480px;min-width:150px" method="post"><div class="title"><h2>Registro</h2></div>
	...
	<div class="element-email<?php frmd_add_class("email"); ?>"><label class="title">Correo<span class="required">*</span></label><input class="large" type="email" name="email" value="" required="required"/></div>
